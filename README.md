...
47. How would you migrate data from an old non scalable DB to a new scalable DB with 0 downtime and ensuring that no stale data is returned to the user.
